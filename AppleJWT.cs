...
namespace rajapet.Apple
{
    public class AppleJWT
    {
        ...
        /// </summary>
        /// <param name="keyId">A 10-character key identifier generated for Apple private key associated with your developer account.</param>
        /// <param name="issuerID">Your 10-character Team ID associated with your developer account</param>
